...
<div class="col-md-9 wrapper">
    <div class="alert alert-jim">
        ...
        <form action="<?php echo $config->base_url('population/saveprofile/member');?>" method="post" class="form-submit">
            <table class="table table-bordered table-hover" border="1">
                <tr>
                    <td>Family Profile ID :<br /><small style="font-weight: 100;" class="text-info">(or Philhealth ID #)</small></td>
                    <td><input type="text" readonly name="familyID" value="<?php echo $data['familyID']; ?>" class="form-control" required /> </td>
                </tr>
                <tr>
                    <td>Relation to Head :</td>
                    <td>
                        <select name="relation" class="select2 form-control" style="width: 100%">
                            <option>Son</option>
