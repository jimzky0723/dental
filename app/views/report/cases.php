...
$name = $data['name'];
?>
<?php $controller->view('sidebar/reportcase',$data); ?>
<div class="col-md-9 wrapper">
    <div class="alert alert-jim">
        ...
        <h2 class="page-header">Cases Referred</h2>
                ...
                <table class="table table-striped talble-hover">
                    ...
                    <?php foreach($profiles as $p): ?>
                        <tr>
                            ...
                            <td class="text-info">
                                <?php echo $controller->getValue('cases','description','id',$p->case_id); ?>
                            </td>
                            <td class="text-info">
                                <?php if($holder!=$p->profile_id): ?>
                                    <?php $holder = $p->profile_id; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="remove">
    <div class="modal-dialog modal-sm" role="document">
        <form method="POST" action="<?php echo $config->base_url('report/removeCase') ; ?>">
